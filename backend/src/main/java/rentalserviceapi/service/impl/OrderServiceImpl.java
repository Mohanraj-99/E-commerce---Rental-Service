package rentalserviceapi.service.impl;


import rentalserviceapi.entity.OrderMain;
import rentalserviceapi.entity.ProductInOrder;
import rentalserviceapi.entity.ProductInfo;
import rentalserviceapi.enums.OrderStatusEnum;
import rentalserviceapi.enums.ResultEnum;
import rentalserviceapi.exception.MyException;
import rentalserviceapi.repository.OrderRepository;
import rentalserviceapi.repository.ProductInOrderRepository;
import rentalserviceapi.repository.ProductInfoRepository;
import rentalserviceapi.repository.UserRepository;
import rentalserviceapi.service.OrderService;
import rentalserviceapi.service.ProductService;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    @Transactional
    public OrderMain decline(Long orderId) {
        OrderMain orderMain = findOne(orderId);
        if(!orderMain.getOrderStatus().equals(OrderStatusEnum.NEW.getCode())) {
            throw new MyException(ResultEnum.ORDER_STATUS_ERROR);
        }

        orderMain.setOrderStatus(OrderStatusEnum.DECLINED.getCode());
        orderRepository.save(orderMain);
