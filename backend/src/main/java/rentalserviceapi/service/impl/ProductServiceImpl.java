...
import rentalserviceapi.enums.ProductStatusEnum;
...
import rentalserviceapi.service.CategoryService;
...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public Page<ProductInfo> findAll(String name ,Pageable pageable ) {
        return productInfoRepository.findAllByProductOwnerOrderByProductId(name , pageable);
    }
